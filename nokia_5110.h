...
#define BIAS        0x10		//контраст оноже опорное напр€жение 0 - 7
#define TC			0x04      //температурный контроль (0-3)
...
void lcd_set_rect (unsigned char y, unsigned char x ,uint32_t L, _Bool invert);//рисуем пр€моугольник висотой 8 пикселей
void Init_Timer2 ();
